...
GERRG Frequently Bought Together for Woocommerce is a simple lightweight designed to improve sales and customer experience with the click of a button. This plugin does not hide features behind any "pay-walls" like so many others.

https://www.youtube.com/watch?v=0JWYMaRJts0
...
1. Backend form for grouping products together for single-click add-to-cart.
2. Adding everything to the cart with a simple click.
3. Adding products to the frequently bought together select box using Select2 AJAX search

== Practical uses == 

Allows admins to easily add related products to be purchased together with the click of a button. This acts as a fantastic reminder that you might want this "snazzy hat" with that dope shirt. Hopefully, this plugin increases average order value buy including additional items that might otherwise be over looked. 
